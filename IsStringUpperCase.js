...
// contain any lowercase letter so any string containing no letters at 
...
//steps
//--check if a string is in uppercase, if yes return true,
//-- if in lowercase return false
//-- if the string is empty, return  true too.
