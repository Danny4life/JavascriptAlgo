...
//Steps
//-- sqaure the input, 
//-- then check if the squared input is greater than 1000
//-- if its greater than 1000, return It's hotter than the sun!!
//-- else return Help yourself to a honeycomb Yorkie for the glovebox

function apple(x){
    let sqr = x * x;

    return (sqr > 1000) ? "It\'s hotter than the sun!!" : "Help yourself to a honeycomb Yorkie for the glovebox.";
    }
    

console.log(apple(400));