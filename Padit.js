// If you want your code to do a lot of similar work, a loop statement 
// is a good choice. For example, if we need to calculate the cumulative value 
// from 1 to 10, we can write code like this:
...
// so if the condition is false the code inside the while loop is never executed. 
// In contrast, do..while always runs once, and then starts checking the condition after that.

// Finally, it is worth mentioning: Do not forget to change the value of the variable 
// (for conditional expressions), otherwise it will turn into an infinite loop.
...
//STEPS
//lOOP thorugh n 
// make * pad to the left
// make * pad to the right 
